...
| ~~data-tooltip-events~~        | ~~string~~ | ~~false~~ | ~~`hover`~~ | ~~`hover click` `hover` `click`~~                                                                                                 | ~~Events to watch for when handling the tooltip state~~ <br/>**Removed in v6.**<br/>Use `openOnClick` tooltip prop instead                    |
...
| `content`               | `ReactNode`                | no       |                     |                                                                                                                                   | Content to be displayed in tooltip (`string`, JSX, etc.)                                                                                                       |
...
| ~~`anchorId`~~          | ~~`string`~~               | ~~no~~   |                     | ~~any `string`~~                                                                                                                  | ~~The id for the anchor element for the tooltip~~ <br/>**Removed in v6.**<br/>Use `data-tooltip-id` or `anchorSelect` instead                                       |
...
| `children`              | React node                 | no       | `undefined`         | valid React children                                                                                                              | The tooltip children have lower priority compared to the `content` prop and the `data-tooltip-content` attribute. Useful for setting default rich content       |
| ~~`events`~~            | ~~`string[]`~~             | ~~no~~   | ~~`hover`~~         | ~~`hover` `click`~~                                                                                                               | ~~Events to watch for when handling the tooltip state~~ <br/>**Removed in v6.**<br/>Use `openOnClick` tooltip prop instead                                          |
...
| ~~`closeOnEsc`~~        | ~~`boolean`~~              | ~~no~~   | ~~`false`~~         | ~~`true` `false`~~                                                                                                                | ~~Pressing escape key will close the tooltip~~ <br/>**Removed in v6.**<br/>Use `globalCloseEvents` instead.                                                         |
| ~~`closeOnScroll`~~     | ~~`boolean`~~              | ~~no~~   | ~~`false`~~         | ~~`true` `false`~~                                                                                                                | ~~Scrolling will close the tooltip~~ <br/>**Removed in v6.**<br/>Use `globalCloseEvents` instead.                                                                   |
| ~~`closeOnResize`~~     | ~~`boolean`~~              | ~~no~~   | ~~`false`~~         | ~~`true` `false`~~                                                                                                                | ~~Resizing the window will close the tooltip~~ <br/>**Removed in v6.**<br/>Use `globalCloseEvents` instead.                                                         |
