...
| `REACT_APP_REACT_TOOLTIP_DISABLE_CORE_STYLES` | `boolean` | no       | `false` | `true` `false` | Same as `REACT_TOOLTIP_DISABLE_CORE_STYLES` but with `REACT_APP_` prefix.                                                                                                                                                                     |
...
| `REACT_APP_REACT_TOOLTIP_DISABLE_BASE_STYLES` | `boolean` | no       | `false` | `true` `false` | Same as `REACT_TOOLTIP_DISABLE_BASE_STYLES` but with `REACT_APP_` prefix.                                                                                                                                                                     |
